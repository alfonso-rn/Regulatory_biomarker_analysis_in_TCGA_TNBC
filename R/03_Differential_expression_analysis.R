# 3. Differential expression analysis: TNBC vs non-TNBC ----
#
...
# 3.2. DEGs table with expression values ----
...
# 3.3. Volcano plot representation ----
...
# 3.4. Horizontal bar plot representation ----
...
# 3.5. Gene type distribution summary table ----
